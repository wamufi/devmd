...
actor ApiClient {
	...
	/// 업로드
    func upload<T: Decodable>(_ data: Data, to url: String, method: HTTPMethod = .post, of type: T.Type = T.self, progressHandler: @escaping (Double) -> Void) async throws -> T {
        return try await withCheckedThrowingContinuation { continuation in
            AF.upload(data, to: url).validate()
